...
def _get_app_info_cache_singleton():
    """Return shared app_info_cache singleton."""
    from email_server.utils.app_info_cache import app_info_cache
...
class SmartMainWindow(QMainWindow):
    ...
    def restore_window_geometry(self):
        ...
        try:
            app_info_cache = _get_app_info_cache_singleton()
